...
SITE_NAME="${SITE_NAME:-SLB BC KARYA SEJAHTERA}"
...
E_CLOUDINARY_UPLOAD_PRESET=$(esc "$CLOUDINARY_UPLOAD_PRESET")
...
sed \
    ...
    -e "s/define('CLOUDINARY_UPLOAD_PRESET', '[^']*')/define('CLOUDINARY_UPLOAD_PRESET', '${E_CLOUDINARY_UPLOAD_PRESET}')/" \
